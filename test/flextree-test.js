...
tape("flextree() exports what it should.", function(test) {
  console.log('=====================================');
  console.log('flextree (main export from package): ', flextree);
  test.equal(flextree(), 42);
  test.isFunction(flextree.hierarchy);
  test.end();
});

/*
tape("computes a simple tree layout", function(t)
  //var t = flextree();
